...
use Generated\Api\Storefront\CartVouchersStorefrontResource;
use Generated\Shared\Transfer\CartCodeRequestTransfer;
use Generated\Shared\Transfer\CartCodeResponseTransfer;
use Generated\Shared\Transfer\CustomerTransfer;
use Generated\Shared\Transfer\RestDiscountsRequestAttributesTransfer;

class CartVouchersStorefrontProcessor extends AbstractCartCodesStorefrontProcessor
{
    ...
    protected function extractCodeFromTypedData(mixed $data): ?string
    {
        ...
        if ($data instanceof CartVouchersStorefrontResource) {
            return $data->code;
        }
